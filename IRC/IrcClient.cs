...
namespace BlackList
{
    ...
    public sealed partial class IrcClient
    {
        ...
        {
            new ColorX("默认颜色", Brushes.White, 0),
            new ColorX("默认颜色 #2", Brushes.White, 1),
            new ColorX("浅蓝色", Brushes.LightBlue, 2),
            new ColorX("绿色", Brushes.ForestGreen, 3),
            new ColorX("深红色", Brushes.MediumVioletRed, 4),
            new ColorX("红色", Brushes.Red, 5),
            new ColorX("紫色", Brushes.MediumOrchid, 6),
            new ColorX("橙色", Brushes.Orange, 7),
            new ColorX("黄色", Brushes.Yellow, 8),
            new ColorX("浅绿色", Brushes.Lime, 9),
            new ColorX("青绿色", Brushes.Turquoise, 10),
            new ColorX("天蓝色", Brushes.LightSkyBlue, 11),
            new ColorX("蓝色", Brushes.RoyalBlue, 12),
            new ColorX("粉红色", Brushes.Fuchsia, 13),
            new ColorX("灰色", Brushes.LightGray, 14),
            new ColorX("灰色 #2", Brushes.Gray, 15),
        }.AsReadOnly();
